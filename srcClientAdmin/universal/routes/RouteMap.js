...
export { default as ArticlesList } from 'universal/modules/articles/pages/articlesList';
...
export const LoadableLogin = Loadable({
  ...
  // delay: 25000,
  serverSideRequirePath: path.join(__dirname, 'universal/modules/authorization/containers/Login'),
});
