  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Eczar:400" rel="stylesheet" />
        {PROD && <link rel="stylesheet" type="text/css" href="/static/0.css" />}
        {PROD && <link rel="stylesheet" type="text/css" href="/static/app.css" />}
        {PROD && styles.map(style => (
          <link rel="stylesheet" type="text/css" href={`/static/${style.file}`} />
        ))}
        {PROD && scripts.map(script => (
